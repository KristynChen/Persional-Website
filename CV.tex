...
\begin{center}
  ...
  %\href{https://www.linkedin.com/in/yishan-chen}{\underline{领英}} $|$
  %\href{https://www.kdocs.cn/l/cikfMzxMUo6m?from=docs}{\underline{作品集}}
\end{center}
...
\resumeSubHeadingListStart
  \resumeProjectHeading
    {\textbf{terny.ai —— Agentic AI科研机会匹配系统}}{2025年11月 -- 至今}
    \resumeItemListStart
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
      ...
      \resumeItem{独立搭建并在代码维度实现基于图神经网络（GNNs）与 Transformer 的计算底座，高度重构并客制化具备跨模型可复用的核心 PyTorch 计算集群代码。}
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
      ...
      \resumeItem{运用 sklearn 实现 Hinge 梯度下降法建立线性回归模型进行房价预测，通过调整模型参数以优化性能。}
      \resumeItem{交付具备高复用性的基础推断验证模组，模型最终实现了 0.38 RMSE 的高精度预测水准。}
    \resumeItemListEnd

  \resumeProjectHeading
    {\textbf{假新闻文本分类网络与态势可视化 Dashboard $|$ 全栈开发}}{2025年9月 -- 2025年12月}
    \resumeItemListStart
      ...
      \resumeItem{使用Shiny技术图谱封装端侧数据监测前哨面板工具解法，将复杂算法预测算力封装接入用户即查型直观控制 Dashboard 面板。}
    \resumeItemListEnd
\resumeSubHeadingListEnd
...
\begin{itemize}[leftmargin=0.15in,label={}]
  \small \item {
    \textbf{AI应用与工程}: Agentic Workflow (编排与任务流), LLM Prompt Engineering, Codex Code Gen\\
    \textbf{数据与算法}: Python, PyTorch (GNN/Transformer), pandas, NumPy, scikit-learn, SQL \\
    \textbf{开发与工具}: Git, Shiny (前端面板封装展示), MATLAB, C/C++ \\
