...
\resumeSubHeadingListStart
  \resumeProjectHeading
    ...
    \resumeItemListStart
      \resumeItem{主导校园数字化转型项目，联合台北市政府推行线上点餐与自助設備；項目落地後日均服務 800+ 學生，熱食部單日營業額提升 40\%，累計受益學生逾 6000 人。}
      \resumeItem{獨立識別學生痛點並完成跨部門提案，協調學校、政府、供應商三方完成系統部署，並代表團隊出席新聞發布會進行項目匯報。}
    \resumeItemListEnd
